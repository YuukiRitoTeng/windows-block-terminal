    ...
    return (
        ...
        >
            ...
            <PopoverContent className="workspace-switcher-content">
                <div className="title">{isActiveWorkspaceSaved ? uiText("workspace.switch") : uiText("workspace.open")}</div>
                ...
                <div className="actions">
                    {isActiveWorkspaceSaved ? (
                        <ExpandableMenuItem onClick={() => env.electron.createWorkspace()}>
                            ...
                            <div className="content">{uiText("workspace.create")}</div>
                        </ExpandableMenuItem>
                    ) : (
                        <ExpandableMenuItem onClick={() => saveWorkspace()}>
                            ...
                            <div className="content">{uiText("workspace.save")}</div>
                        </ExpandableMenuItem>
                    )}
                </div>
            </PopoverContent>
...
const WorkspaceSwitcherItem = ({
    ...
    const editIconDecl: IconButtonDecl = {
        ...
        className: "edit",
        icon: "pencil",
        title: uiText("connection.editWorkspace"),
        click: (e) => {
            e.stopPropagation();
    ...
    const windowIconDecl: IconButtonDecl = {
        ...
        title: isCurrentWorkspace ? uiText("connection.currentWorkspace") : uiText("connection.openWorkspace"),
    };
