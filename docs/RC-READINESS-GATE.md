...
| `vim`                                                       | `NOT_YET_VALIDATED`         | `NOT YET TESTED`                        | Packaged manual PTY test                                 | YES unless scoped out | `vim` was unavailable in the current RC evidence and was not tested                      |
| Alternate-screen                                            | `NOT_YET_VALIDATED`         | `EVIDENCE EXISTS — REVALIDATION NEEDED` | Packaged manual PTY test                                 | YES unless scoped out | ConPTY evidence exists, but no current packaged RC workload                              |
...
| `NOT YET TESTED`                        |    12 |
| `EVIDENCE EXISTS — REVALIDATION NEEDED` |    14 |
