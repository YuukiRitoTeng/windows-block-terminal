...
| Interactive program exit → ordinary command resumes | `PASS`                                  | RC-EVIDENCE-3 Recovery Batch 2 records Python REPL and nested PowerShell exit followed by ordinary commands with the same outer session.                                                                                                                             | The next ordinary command executes in the same supported session with preserved cwd/session state and no second shell/runspace.                                                                                                                                                                                                                                                                                                                              | YES — unless explicitly excluded |
...
| Packaged app restart               | `PASS`                                  | RC-EVIDENCE-3 Recovery Batch 2 records normal close/restart of the installed artifact, wavesrv/hosted readiness and restoration of finished records without duplication.           | The declared RC artifact starts, wavesrv is ready, hosted resources resolve, and durable history remains available.                                                    | YES                              |
