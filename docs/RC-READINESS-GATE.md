...
region, and Clear remains global with session preservation. Neither decision
authorizes heuristic attribution or changes the evidence/status inventory below.
...
| `NOT YET TESTED`                        |     6 |
| `EVIDENCE EXISTS — REVALIDATION NEEDED` |     9 |
